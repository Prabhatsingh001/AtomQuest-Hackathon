...
import type { User, Cycle, Department } from '@/types';
...
export default function UserManager() {
  ...
  const load = async () => {
    ...
    try { 
      ...
      setActiveCycle(cycles.find((c: Cycle) => c.is_active) || null);
    }
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex gap-6">
        ...
        {/* Form Panel */}
        {(isNew || editing) && (
          <div className="w-80 shrink-0 bg-white border border-zinc-200 rounded-xl p-5 self-start sticky top-6">
