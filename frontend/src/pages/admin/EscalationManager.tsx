...
export default function EscalationManager() {
    ...
    const { data: rules = [], isLoading: loading } = useQuery({
        ...
        queryFn: () => adminApi.getEscalationRules(),
        staleTime: 1000 * 60 * 2,
    });
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-6">
            ...
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                {(isNew || editing) && (
                    <div className="w-full lg:w-80 flex-shrink-0 bg-white border border-zinc-200 rounded-xl p-5 self-start sticky top-20 shadow-sm">
