...
export default function AuditLogPage() {
  ...
  useEffect(() => {
    setLoading(true);
    adminApi.getAuditLogs({ page, page_size: 20, entity_type: entityFilter || undefined })
  ...
  const exportCsv = () => {
    ...
    logs.forEach(l => rows.push([new Date(l.timestamp).toISOString(), l.changed_by_name || '', `${l.entity_type}:${l.entity_id}`, l.action, l.reason || '']));
